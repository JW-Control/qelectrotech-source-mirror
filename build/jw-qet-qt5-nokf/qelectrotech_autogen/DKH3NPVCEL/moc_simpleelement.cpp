...
struct qt_meta_stringdata_SimpleElement_t {
    QByteArrayData data[1];
    char stringdata0[14];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_SimpleElement_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_SimpleElement_t qt_meta_stringdata_SimpleElement = {
    {
QT_MOC_LITERAL(0, 0, 13) // "SimpleElement"
...
QT_INIT_METAOBJECT const QMetaObject SimpleElement::staticMetaObject = { {
    QMetaObject::SuperData::link<Element::staticMetaObject>(),
    qt_meta_stringdata_SimpleElement.data,
    qt_meta_data_SimpleElement,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *SimpleElement::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_SimpleElement.stringdata0))
