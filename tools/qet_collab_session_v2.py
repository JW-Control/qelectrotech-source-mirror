...
The original qet_collab_session module remains the merge engine. This wrapper
extends workspace discovery so manifests stored below .jwqet/incoming remain
portable between PCs whose shared Drive uses different drive letters.
"""
