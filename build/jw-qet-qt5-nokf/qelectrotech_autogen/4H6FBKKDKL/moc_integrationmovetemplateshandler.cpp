...
struct qt_meta_stringdata_IntegrationMoveTitleBlockTemplatesHandler_t {
    QByteArrayData data[3];
    char stringdata0[63];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_IntegrationMoveTitleBlockTemplatesHandler_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_IntegrationMoveTitleBlockTemplatesHandler_t qt_meta_stringdata_IntegrationMoveTitleBlockTemplatesHandler = {
    {
QT_MOC_LITERAL(0, 0, 41), // "IntegrationMoveTitleBlockTemp..."
QT_MOC_LITERAL(1, 42, 19), // "correctRadioButtons"
...
void IntegrationMoveTitleBlockTemplatesHandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<IntegrationMoveTitleBlockTemplatesHandler *>(_o);
        (void)_t;
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject IntegrationMoveTitleBlockTemplatesHandler::staticMetaObject = { {
    QMetaObject::SuperData::link<MoveTitleBlockTemplatesHandler::staticMetaObject>(),
    qt_meta_stringdata_IntegrationMoveTitleBlockTemplatesHandler.data,
    qt_meta_data_IntegrationMoveTitleBlockTemplatesHandler,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *IntegrationMoveTitleBlockTemplatesHandler::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_IntegrationMoveTitleBlockTemplatesHandler.stringdata0))
