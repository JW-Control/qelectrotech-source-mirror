...
QT_MOC_LITERAL(1, 9, 17), // "conductorWasAdded"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 10), // "Conductor*"
QT_MOC_LITERAL(4, 39, 9), // "conductor"
QT_MOC_LITERAL(5, 49, 19) // "conductorWasRemoved"

    },
    "Terminal\0conductorWasAdded\0\0Conductor*\0"
    "conductor\0conductorWasRemoved"
};
...
void Terminal::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->conductorWasAdded((*reinterpret_cast< Conductor*(*)>(_a[1]))); break;
        case 1: _t->conductorWasRemoved((*reinterpret_cast< Conductor*(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Terminal::*)(Conductor * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Terminal::conductorWasAdded)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Terminal::*)(Conductor * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Terminal::conductorWasRemoved)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void Terminal::conductorWasAdded(Conductor * _t1)
{
...
// SIGNAL 1
void Terminal::conductorWasRemoved(Conductor * _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
