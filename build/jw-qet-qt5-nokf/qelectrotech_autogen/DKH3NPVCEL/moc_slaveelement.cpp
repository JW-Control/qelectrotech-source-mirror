...
struct qt_meta_stringdata_SlaveElement_t {
    QByteArrayData data[1];
    char stringdata0[13];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_SlaveElement_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_SlaveElement_t qt_meta_stringdata_SlaveElement = {
    {
QT_MOC_LITERAL(0, 0, 12) // "SlaveElement"
...
QT_INIT_METAOBJECT const QMetaObject SlaveElement::staticMetaObject = { {
    QMetaObject::SuperData::link<Element::staticMetaObject>(),
    qt_meta_stringdata_SlaveElement.data,
    qt_meta_data_SlaveElement,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *SlaveElement::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_SlaveElement.stringdata0))
