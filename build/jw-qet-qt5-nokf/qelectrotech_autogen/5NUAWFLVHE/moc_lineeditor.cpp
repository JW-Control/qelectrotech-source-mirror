...
#include <memory>
#include "../../../../sources/editor/ui/lineeditor.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_LineEditor_t, stringdata0) + ofs \
...
QT_INIT_METAOBJECT const QMetaObject LineEditor::staticMetaObject = { {
    QMetaObject::SuperData::link<ElementItemEditor::staticMetaObject>(),
    qt_meta_stringdata_LineEditor.data,
    qt_meta_data_LineEditor,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *LineEditor::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_LineEditor.stringdata0))
