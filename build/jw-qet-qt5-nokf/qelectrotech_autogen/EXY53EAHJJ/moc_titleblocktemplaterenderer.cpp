...
struct qt_meta_stringdata_TitleBlockTemplateRenderer_t {
    QByteArrayData data[1];
    char stringdata0[27];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_TitleBlockTemplateRenderer_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_TitleBlockTemplateRenderer_t qt_meta_stringdata_TitleBlockTemplateRenderer = {
    {
QT_MOC_LITERAL(0, 0, 26) // "TitleBlockTemplateRenderer"
...
QT_INIT_METAOBJECT const QMetaObject TitleBlockTemplateRenderer::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_TitleBlockTemplateRenderer.data,
    qt_meta_data_TitleBlockTemplateRenderer,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *TitleBlockTemplateRenderer::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_TitleBlockTemplateRenderer.stringdata0))
