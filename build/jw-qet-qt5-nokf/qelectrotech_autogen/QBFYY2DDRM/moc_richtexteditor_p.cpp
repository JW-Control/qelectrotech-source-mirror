...
QT_MOC_LITERAL(1, 41, 13), // "applyEditText"
QT_MOC_LITERAL(2, 55, 0), // ""
QT_MOC_LITERAL(3, 56, 15), // "tabIndexChanged"
QT_MOC_LITERAL(4, 72, 8), // "newIndex"
QT_MOC_LITERAL(5, 81, 15), // "richTextChanged"
QT_MOC_LITERAL(6, 97, 13), // "sourceChanged"
QT_MOC_LITERAL(7, 111, 21) // "on_buttonBox_accepted"

    },
    "qdesigner_internal::RichTextEditorDialog\0"
    "applyEditText\0\0tabIndexChanged\0newIndex\0"
...
void qdesigner_internal::RichTextEditorDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<RichTextEditorDialog *>(_o);
        (void)_t;
        switch (_id) {
        ...
        {
            using _t = void (RichTextEditorDialog::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&RichTextEditorDialog::applyEditText)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject qdesigner_internal::RichTextEditorDialog::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_meta_stringdata_qdesigner_internal__RichTextEditorDialog.data,
    qt_meta_data_qdesigner_internal__RichTextEditorDialog,
    qt_static_metacall,
    nullptr,
    nullptr
} };
