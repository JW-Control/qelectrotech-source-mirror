...
struct qt_meta_stringdata_PartArc_t {
    QByteArrayData data[1];
    char stringdata0[8];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_PartArc_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_PartArc_t qt_meta_stringdata_PartArc = {
    {
QT_MOC_LITERAL(0, 0, 7) // "PartArc"
...
QT_INIT_METAOBJECT const QMetaObject PartArc::staticMetaObject = { {
    QMetaObject::SuperData::link<AbstractPartEllipse::staticMetaObject>(),
    qt_meta_stringdata_PartArc.data,
    qt_meta_data_PartArc,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *PartArc::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_PartArc.stringdata0))
