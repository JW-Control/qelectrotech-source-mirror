...
struct qt_meta_stringdata_BorderPropertiesWidget_t {
    QByteArrayData data[1];
    char stringdata0[23];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_BorderPropertiesWidget_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_BorderPropertiesWidget_t qt_meta_stringdata_BorderPropertiesWidget = {
    {
QT_MOC_LITERAL(0, 0, 22) // "BorderPropertiesWidget"
...
QT_INIT_METAOBJECT const QMetaObject BorderPropertiesWidget::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_BorderPropertiesWidget.data,
    qt_meta_data_BorderPropertiesWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *BorderPropertiesWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_BorderPropertiesWidget.stringdata0))
