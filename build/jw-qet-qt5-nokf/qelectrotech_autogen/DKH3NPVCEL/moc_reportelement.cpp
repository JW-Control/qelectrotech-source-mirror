...
struct qt_meta_stringdata_ReportElement_t {
    QByteArrayData data[1];
    char stringdata0[14];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_ReportElement_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_ReportElement_t qt_meta_stringdata_ReportElement = {
    {
QT_MOC_LITERAL(0, 0, 13) // "ReportElement"
...
QT_INIT_METAOBJECT const QMetaObject ReportElement::staticMetaObject = { {
    QMetaObject::SuperData::link<Element::staticMetaObject>(),
    qt_meta_stringdata_ReportElement.data,
    qt_meta_data_ReportElement,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *ReportElement::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ReportElement.stringdata0))
